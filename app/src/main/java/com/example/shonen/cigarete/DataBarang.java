...
public class DataBarang extends AppCompatActivity
            ...
            public void onClick(View view) {
                ...
                alertDialogBuilderUserInput.setCancelable(false).setPositiveButton("Simpan", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dbHelper.insertDatabarang(nama.getText().toString(),Integer.parseInt(harga.getText().toString()));
                        load();
                    }
                })
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dbHelper.deletebarang(Long.parseLong(sendId));
                        load();
                    }
                });
                alertDialogBuilderUserInput.setCancelable(false).setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dbHelper.updatebarang(Long.parseLong(sendId),nama.getText().toString(),Integer.parseInt(harga.getText().toString()));
                        load();
                    }
                })
                        .setNegativeButton("Batal", new DialogInterface.OnClickListener() {
    ...
    public void load(){
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(DataBarang.this,R.layout.listrokok , cursor, from, to);
        adapter.notifyDataSetChanged();
        list = (ListView) findViewById(R.id.listvrokok);
